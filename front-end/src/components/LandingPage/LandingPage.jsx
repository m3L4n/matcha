    ...
    return (
      <article className='aboutUs'>
        ...
        <article className=''>
          ...
          <p className='body'>{"We believe in complete gender equality, ensuring that everyone is treated with respect and fairness. women and men have equal rights and opportunities to find their soulmate."}</p>
        </article>
        ...
        <article className=''>
          ...
          <p className='body'>
            {"Your safety is our top priority. We employ cutting-edge technology to safeguard your personal data and conversations, allowing you to focus on building real, sincere connections."} <br/>
          </p>
        </article>
        <p className="body">
